...
class RebuildDatasetCallback(Callback):
    ...
    def on_train_epoch_start(self, trainer, pl_module):
        ...
        #print("train_loader_dataset - ",train_loader_dataset)
...
if __name__ == '__main__':
    ...
    # lr_scheduler = {"reduce_on_plateau": True, "scheduler": functools.partial(WarmupConstantSchedule, warmup_steps=warmup_steps), "monitor": "val_loss"}
    # print("lr_step - ",pl.LightningModule.lr_scheduler_step)

    # from torch.optim.lr_scheduler import ReduceLROnPlateau
    # optimizer = Adam(...)
    # from torch.optim.lr_scheduler import LambdaLR
    
    # def cosine_scheduler(optimizer, warmup_steps):
    #     def lr_lambda(current_step):
    #         if current_step < warmup_steps:
    #             return current_step / max(1, warmup_steps)
    #         progress = current_step - warmup_steps
    #         progress /= max(1, warmup_steps)
    #         return max(0.0, 0.5 * (1.0 + math.cos(math.pi * progress)))
    #     return LambdaLR(optimizer, lr_lambda)
    # lr_scheduler = functools.partial(cosine_scheduler, warmup_steps=warmup_steps)
    ...
    # ========== training dataset
    mega_dataset1 = MegaDepthDataset(root=mega_dir, train=True, using_cache=debug, pairs_per_scene=16,
                                     image_size=image_size, gray=False, colorjit=True, crop_or_scale='crop')
    mega_dataset2 = MegaDepthDataset(root=mega_dir, train=True, using_cache=debug, pairs_per_scene=16,
                                     image_size=image_size, gray=False, colorjit=True, crop_or_scale='scale')
    # print("mega_dataset1 - ",mega_dataset1.__len__())
    # print("mega_dataset2 - ",mega_dataset2.__len__())
    ...
    # print("hpatch_i_dataset - ",hpatch_i_dataset.__len__())
    # print("hpatch_v_dataset - ",hpatch_v_dataset.__len__())
    ...
    # print("imw2020val - ",imw2020val.__len__())
    ...
    # ========================================= trainer
    trainer = pl.Trainer(accelerator="auto",#gpus=gpus,
    ...
    # print("lr_step - ",pl.LightningModule.lr_scheduler_step)
    # print("train_loader - ",train_loader.build_dataset())
